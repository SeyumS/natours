...
var hideAlert = exports.hideAlert = function hideAlert() {
  var el = document.querySelectot('.alert');
  if (el) el.parentElement.removeChild(el);
};
var showAlert = exports.showAlert = function showAlert(type, msg) {
  hideAlert();
  var markup = "<div class=\"allert alert--".concat(type, "\"</div>");
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), "\n    updated successfully!"));
          }
          _context.next = 11;
          break;
        case 8:
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripe = Stripe('pk_test_51RQPZMQJWLre3pYPJKEpjcIudLkqx6VDB3ENRZngRPHUAy6oN1iIvM8glYJEfvlMyFr5z6ysdjOeRoHsbV1HyFhL00lrIv12Dy');
...
var logOutBtn = document.wuerySelector('.nav__el--logout');
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    ...
    var tourId = e.target.dataset.tourId.tourId;
